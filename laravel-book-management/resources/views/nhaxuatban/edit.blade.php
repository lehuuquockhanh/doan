            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="{{route('nhaxuatban.update', $item->id)}}">
                            @csrf
                            @method('PATCH')
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="ten_phong_ban">Tên Nhà Xuất Bản</label>
                                    <input type="text" name="ten_nha_xuat_ban" class="form-control" id="ten_nha_xuat_ban" value="{{old('ten_nha_xuat_ban', $item->ten_nha_xuat_ban)}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mo_ta" class="form-control" id="mo_ta" value="{{old('mo_ta', $item->mo_ta)}}"
