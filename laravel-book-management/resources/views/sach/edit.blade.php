            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="{{route('sach.update', $item->id)}}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{ \Illuminate\Support\Facades\URL::to('/' . $item->hinh_anh_1) }}"
                                         class="img-thumbnail" width="100">
                                    <input type="hidden" name="hidden_image_1" value="{{$item->hinh_anh_1}}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="tac_gia" name="tac_gia">
                                        ...
                                        @foreach($tacgias as $key => $tacgia)
                                            <option value="{{$tacgia->id}}"
                                                    @if($tacgia->id == old('tac_gia', $item->tac_gia)) selected @endif>{{$tacgia->ten_tac_gia}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="nha_xuat_ban" name="nha_xuat_ban">
                                        ...
                                        @foreach($nhaxuatbans as $key => $nxb)
                                            <option value="{{$nxb->id}}"
                                                    @if($nxb->id == old('nha_xuat_ban', $item->nha_xuat_ban)) selected @endif>{{$nxb->ten_nha_xuat_ban}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="the_loai" name="the_loai">
                                        ...
                                        @foreach($theloais as $key => $theloai)
                                            <option value="{{$theloai->id}}"
                                                    @if($theloai->id == old('the_loai', $item->the_loai)) selected @endif>{{$theloai->ten_the_loai}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="gia_nhap" class="form-control" id="gia_nhap"
                                           value="{{old('gia_nhap', $item->gia_nhap)}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="gia_ban" class="form-control" id="gia_ban"
                                           value="{{old('gia_ban', $item->gia_ban)}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="gia_khuyen_mai" class="form-control" id="gia_khuyen_mai"
                                           value="{{old('gia_khuyen_mai', $item->gia_khuyen_mai)}}"
                                ...
                                <div class="custom-control custom-checkbox text-left mb-4">
                                    <input type="checkbox" class="custom-control-input" name="is_pin"
                                           id="defaultUnchecked" {{$item->ghim ? 'checked' : ''}}>
                                    <label class="custom-control-label" for="defaultUnchecked">Pin Product</label>
                                </div>
                            </div>
                            <!-- /.card-body -->
